namespace EsfEditor.Core.EsfObjects
{
    ...
    public class EsfMultiNode : EsfNode, IEsfNode, IEsfValue
    {
        public EsfMultiNode(EsfParser outer)
        {
            base.Values = new List<IEsfValue>();
            base.Parser = outer;
        }

        public EsfMultiNode(IEsfNode esfNode, IEsfNode parent, EsfParser parser) : base(esfNode, parent, parser)
        {
        ...
        public override IEsfNode CopyTo(IEsfNode destination, int index)
        {
            ...
            IEsfNode newNode = new EsfMultiNode(this, destination, destination.Parser) {
